...
namespace Ecommerce.Data.Migrations
{
    ...
    [Migration("20241201052532_UpdateStockTableName")]
    partial class UpdateStockTableName
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            modelBuilder
                .HasAnnotation("ShoeVersion", "9.0.0")
            ...
            modelBuilder.Entity("Ecommerce.Models.Stock", b =>
                {
                    b.HasOne("YourNamespace.Models.Shoe", "Shoe")
                        .WithOne("Stock")
                        .HasForeignKey("Ecommerce.Models.Stock", "ShoeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
