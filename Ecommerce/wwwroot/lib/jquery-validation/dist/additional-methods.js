 ...
 *
 *	<input class="Shoeinfo" name="partnumber">
 *	<input class="Shoeinfo" name="description">
 *
 *	...will validate unless at least one of them is filled.
 *
 * partnumber:	{require_from_group: [1,".Shoeinfo"]},
 * description: {require_from_group: [1,".Shoeinfo"]}
 *
 ...
 *	<input class="Shoeinfo" name="partnumber">
 *	<input class="Shoeinfo" name="description">
 *	<input class="Shoeinfo" name="color">
 *
 *	...will validate unless either at least two of them are filled,
 *	OR none of them are.
 *
 * partnumber:	{skip_or_fill_minimum: [2,".Shoeinfo"]},
 * description: {skip_or_fill_minimum: [2,".Shoeinfo"]},
 * color:		{skip_or_fill_minimum: [2,".Shoeinfo"]}
 *
 * options[0]: number of fields that must be filled in the group
 * options[1]: CSS selector that defines the group of conditionally required fields
 *
